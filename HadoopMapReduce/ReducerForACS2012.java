...
public class ReducerForACS2012 extends Reducer<IntWritable, IntWritable, Text, IntWritable> {
    ...
    public void reduce(IntWritable key, Iterable<IntWritable> values, 
      ...
      result.set(sum);
      keyText.set(getCitizenshipStatus(key.get()));
      context.write(keyText, result);
    }

	private String getCitizenshipStatus(Integer citField) {
		switch(citField){
		case 1:
